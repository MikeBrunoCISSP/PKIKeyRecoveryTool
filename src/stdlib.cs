...
namespace PKIKeyRecovery
{
    public class stdlib
    {
        ...
        public static void SendMail(string sender, string recipient, string subject, string message, string attachment=null)
        {
            ...
            client.Host = RuntimeContext.Conf.SmtpServer;
            client.Send(mail);
        }
